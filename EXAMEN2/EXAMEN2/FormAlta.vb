...
Public Class FormAlta
    ...
    Private Sub cbxPlanAP_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxPlanAP.SelectedIndexChanged
        Dim cod As String = cbxPlanAP.SelectedValue.ToString 'aca voy a guardar los valores del valueMember del combo Pais (VAL para convertirlo a numero previo al string)
        ...
        With cbxPlanAP 'Recorro y lleno el cbxPaisP con los nombres de la tabla paises
            .DataSource = Dt3
